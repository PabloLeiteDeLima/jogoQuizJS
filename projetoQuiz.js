...
// SE LIGA! O retorno do 'readline' é sempre uma string. 
...
teclado.question('Qual é seu nome: ', (nome) => {
    if (nome == "") {
        console.log('\n\nTente novamente.\nPois voçê esqueçeu de digitar seu nome.\n')
        teclado.close()//Código trava aqui caso venha sem nome.
    } else {
        console.log('\n\n')
